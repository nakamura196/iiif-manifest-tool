 ...
 *   -> /api/iiif/3/users/{userId}/collections/{collectionId}/items/{itemId}/manifest
 */
export async function GET(request: NextRequest, { params }: RouteParams) {
  ...
  const newPath = `/api/iiif/3/users/${userId}/collections/${collectionId}/items/${itemId}/manifest`;
