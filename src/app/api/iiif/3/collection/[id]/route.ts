 ...
 * /api/iiif/3/collection/{userId}_{collectionId}
 *   -> /api/iiif/3/users/{userId}/collections/{collectionId}
 */
export async function GET(request: NextRequest, { params }: RouteParams) {
  ...
  const newPath = `/api/iiif/3/users/${userId}/collections/${collectionId}`;
